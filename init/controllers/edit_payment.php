<?php
  require_once "../model/class_model.php";
	...
	if(ISSET($_POST)){
		...
		$document_controlno = trim($_POST['document_controlno']);
		...
		$payment = $conn->edit_payment($document_controlno, $total_amount, $amount_paid, $date_ofpayment, $proof_ofpayment, $status, $payment_id);
		if($payment == TRUE){
