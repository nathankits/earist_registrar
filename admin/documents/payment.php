                                              ...
                                              <?php
                                               ...
                                               <?php foreach ($payment as $row) { ?>
                                                <tr>
                                                   ...
                                                   <td>
                                                     <?php 
                                                       if (is_numeric($row['total_amount']) && is_numeric($row['amount_paid'])) {
                                                          $sub_total = ($row['total_amount'] - $row['amount_paid']);
                                                          echo $sub_total;
                                                        } else {
                                                          echo "";
                                                        }
                                                    ...
                                                    <td class="align-right">
                                                        <a href="edit-payment.php?payment=<?= $row['payment_id']; ?>&document-controlnumber=<?php echo $row['control_no']; ?>"  class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
